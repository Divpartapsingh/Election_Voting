...
with tab1:
    ...
    st.write("Election of Chairperson to the board of the ElectionVoting")
    ...
    st.write("The future growth and development of ElectionVoting demands the role of Chairperson is filled by the candidate who can deliver the vision, entrepreneurial approach and compelling leadership that will continue to propel the organisation on a success trajectory that leaves potential competitors in its wake.")
...
# Provide information based on the selected candidate
    ...
    if selected_candidate == 'Gavin Sharp':
        ...
        st.subheader("Current Role: CEO and Founding Partner ElectionVoting")
